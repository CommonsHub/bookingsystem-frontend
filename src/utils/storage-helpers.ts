...
export const saveStorageUser = (email: string, name: string = '', verified: boolean = false): User => {
...
export const saveStorageToken = (id: string, token: string, type: 'booking' | 'comment'): void => {
...
export const addStorageComment = (bookingId: string, comment: Comment): void => {
  // For now, we'll just update the local state
  // In a real implementation, this would save to database
};

export const updateStorageCommentStatus = (bookingId: string, commentId: string, status: 'draft' | 'published'): void => {
  // For now, we'll just update the local state
  // In a real implementation, this would save to database
};

...
export const BookingFormContent = ({
  ...
  return (
    <CardContent className="space-y-8 mt-24 pb-8">
      <div data-wizard-section="0" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="1" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="2" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="3" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="4" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="5" className="scroll-mt-32 py-6">
        <div className="mb-6">
      ...
      <div data-wizard-section="6" className="scroll-mt-32 py-6">
        <div className="mb-6">

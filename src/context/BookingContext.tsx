...
export const BookingProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const { createBooking, addCommentToBooking, approveBookingRequest } = useBookingOperations(bookings, setBookings);
  const { verifyBookingEmail, verifyCommentEmail } = useVerification(bookings, setBookings, setUser);
